...
//=========  (Fri Nov 24 20:08:39 2017) by ROOT version5.34/34
   TCanvas *c004 = new TCanvas("c004", "",65,52,700,527);
   gStyle->SetOptStat(0);
   c004->Range(6775,5.567006,7025,7.694144);
   c004->SetFillColor(0);
   ...
   hFWdist->GetXaxis()->SetRange(41801,42000);
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(6969.484,417584.4,"");
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(6773.567,150.9961,"Counts");
   tex->SetTextFont(42);
   tex->SetTextAngle(89.04516);
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(6781.089,1.391e+07,"Counts");
   tex->SetTextFont(42);
   tex->SetTextAngle(89.10483);
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(6917.55,392532.1,"Distance to FW module");
   tex->SetTextFont(42);
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(7005.301,518544.6,"");
   tex->SetTextFont(42);
   tex->SetLineWidth(2);
   tex->Draw();
   c004->Modified();
